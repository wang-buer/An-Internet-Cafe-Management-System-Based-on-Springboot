...
public class YonghushangjiController {
    ...
    public R update(@RequestBody YonghushangjiEntity yonghushangji, HttpServletRequest request){
        //ValidatorUtils.validateEntity(yonghushangji);
        yonghushangjiService.updateById(yonghushangji);//全部更新
        return R.ok();
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		int count = yonghushangjiService.selectCount(wrapper);
